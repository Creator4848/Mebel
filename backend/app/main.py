...
from backend.app.routers from backend.app.routers import auth, courses, public, enrollments, admin, payments
...
def startup_event():
    try:
        ...
        from backend.app from backend.app import models
